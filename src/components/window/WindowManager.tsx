...
const Finder = dynamic(() => import("../apps/Finder"), {
  loading: () => <div className="h-full w-full bg-white/50 animate-pulse" />,
});
const Safari = dynamic(() => import("../apps/Safari"), {
  loading: () => <div className="h-full w-full bg-white/50 animate-pulse" />,
});
const Terminal = dynamic(() => import("../apps/Terminal"), {
  loading: () => <div className="h-full w-full bg-black/50 animate-pulse" />,
});
const Mail = dynamic(() => import("../apps/Mail"), {
  loading: () => <div className="h-full w-full bg-white/50 animate-pulse" />,
});
const Photos = dynamic(() => import("../apps/Photos"), {
  loading: () => <div className="h-full w-full bg-white/50 animate-pulse" />,
});
const Trash = dynamic(() => import("../apps/Trash"), {
  loading: () => <div className="h-full w-full bg-white/50 animate-pulse" />,
});
        ...
        return (
          ...
          >
            {AppComponent ? (
              ...
              <div className="p-4">Content for {window.title}</div>
            )}
          </WindowFrame>
        );
      })}
