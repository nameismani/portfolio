...
export default function IntroAnimation({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set([textTitleRef.current, textSubRef.current], {
        opacity: 0,
        y: 40,
      });
      ...
      <div className="flex flex-col md:flex-row items-center gap-2 md:gap-12 relative z-10 p-8 max-w-6xl w-full justify-center">
        ...
        <div className="text-center md:text-left flex flex-col justify-center max-w-xl">
          <div ref={textTitleRef} className="overflow-hidden">
            <h1
              className={`${cinzel.className} text-4xl md:text-7xl font-bold text-white mb-2 leading-tight tracking-wider drop-shadow-[0_2px_10px_rgba(255,255,255,0.5)]`}
            >
              WELCOME <br />
          ...
          <div
            ref={textSubRef}
            className="mt-4 border-l-4 border-blue-500 pl-6 bg-blue-900/10 py-2 rounded-r-lg backdrop-blur-sm"
          >
            ...
            <p className="text-lg md:text-xl text-gray-400 mt-1 font-medium">
              User: <span className="text-white font-bold">Manikandan</span>
            </p>
          </div>
        </div>
      </div>
